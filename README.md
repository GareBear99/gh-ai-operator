...
**Live-run evidence**: the first real run against a non-toy codebase (FreeEQ8) is captured in [docs/FIRST_LIVE_RUN.md](./docs/FIRST_LIVE_RUN.md) with the full snapshot, verdict, training record, and ingest manifest. Phase status, activation checklist, and red-team model in [docs/QUALITY_PROOF_PLAN.md](./docs/QUALITY_PROOF_PLAN.md).
...
Set up docs: [`cloudflare/README.md`](cloudflare/README.md).
